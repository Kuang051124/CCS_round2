...
/* A车 — 5段 */
T1Param t4_AO  = { 140.0f, 140.0f, 28.0f, 7.0f,  17.0f, -17.0f,  98.0f, -98.0f };  /* A→O 慢速DELAY */
T1Param t4_OB  = { 140.0f, 140.0f, 28.0f, 7.0f,  17.0f, -17.0f,  98.0f, -98.0f };  /* O→B 慢速DELAY */
T1Param t4_ABC = { 196.0f, 168.0f, 28.0f, 14.0f, 17.0f, -17.0f,  98.0f, -98.0f };  /* BC弧 正常巡线 */
T1Param t4_ACD = { 392.0f, 308.0f, 70.0f, 14.0f, 70.0f, -70.0f, 280.0f, -280.0f }; /* C→D 快速直   */
T1Param t4_ADA = { 392.0f, 308.0f, 70.0f, 14.0f, 70.0f, -70.0f, 280.0f, -280.0f }; /* DA弧 快速回A  */

/* B车 — 5段 */
T1Param t4_BDA = { 392.0f, 308.0f, 70.0f, 14.0f, 70.0f, -70.0f, 280.0f, -280.0f }; /* DA弧 快速追A  */
T1Param t4_BAB = { 392.0f, 308.0f, 70.0f, 14.0f, 70.0f, -70.0f, 280.0f, -280.0f }; /* A→B 快速超A  */
T1Param t4_BBC = { 196.0f, 168.0f, 28.0f, 14.0f, 17.0f, -17.0f,  98.0f, -98.0f };  /* BC弧 正常巡线 */
T1Param t4_BCO = { 140.0f, 140.0f, 28.0f, 7.0f,  17.0f, -17.0f,  98.0f, -98.0f };  /* C→O 慢速DELAY */
T1Param t4_BOD = { 140.0f, 140.0f, 28.0f, 7.0f,  17.0f, -17.0f,  98.0f, -98.0f };  /* O→D 慢速DELAY */
